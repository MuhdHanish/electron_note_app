...
Electron Note App is a simple **note-taking app** that uses **Markdown** syntax to format your notes.

You can create your first note by clicking on the top-left create icon on the sidebar, or delete one by selecting it and clicking on top right delete icon.
...
Here are all the heading formats currently supported by **_Electron Note App_**:
